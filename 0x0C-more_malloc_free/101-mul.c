...
#include <stdlib.h>
/**
 * _atoi_digit - function converts a char to an integer
...
/**
 * _isNumber - function defines if a string is a number
...
/**
 * _calloc - function allocates array of size * nmemb
...
/**
 * mul_array - function multiplies two arrays
 *  @a1: first array
...
/**
 * print_array - function prints all digits of array
...
/**
 * main - function prints the multiplication of 2 numbers
 * @argc: array length
 * @argv: array
 * Return: 0 (success)
 */
